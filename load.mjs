...
export class Wasi {
    ...
    clock_time_get (clockId, precision, timePtr) {
        const countPointerBuffer = new BigUint64Array(this.#instance.exports.memory.buffer, timePtr, 1);
        countPointerBuffer[0] = BigInt(Math.floor(performance.now() * 1000000)); // convert milliseconds to nanoseconds
        return 0;
    }
    random_get() {
        return 0;
